...
- **Accessibility** - Recent-budget rows are proper buttons now, so screen readers can open them, not just remove them.
...
- **Analytics** - Net Worth chart now counts closed/archived accounts toward historical net worth and labels each bar by month-end.
...
- **Web** - User-guide docs page on the promo site (mirrors the in-app Help copy), linked from the footer, the How-to-start section, and beside the hero demo CTA.
